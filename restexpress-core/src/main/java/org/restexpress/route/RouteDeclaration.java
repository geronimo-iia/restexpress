...
/**
 * {@link RouteDeclaration} provide methods to declare {@link Route} and build a {@link RouteMapping}.
 * 
...
public final class RouteDeclaration {
     ...
     * with the URL pattern. Any '.{format}' portion of the URL pattern is omitted. Only named routes are included in the output.
     * 
     * @param baseUrl the Base URL is included in the URL pattern
     * 
    ...
    /**
     * Apply a function Function<RouteBuilder, Void> on each {@link RouteBuilder}.
     * 
     * @param function function to apply against collection
     */
