...
public class DefaultRequestHandler extends AbstractRequestHandler {
     ...
     * @param responseProcessorManager {@link ResponseProcessorManager}
     * @param responseWriter {@link HttpResponseWriter}
    ...
    protected Request createRequest(final MessageEvent event, final ChannelHandlerContext context) {
        return new Request((HttpRequest) event.getMessage(), routeResolver, responseProcessorManager,
