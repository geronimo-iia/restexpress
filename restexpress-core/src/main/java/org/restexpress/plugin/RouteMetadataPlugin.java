...
public class RouteMetadataPlugin extends AbstractRoutePlugin {
    ...
    public static class RouteMetadataController {
         ...
         * 
         * @param serverMetadata {@link ServerMetadata} to use.
         */
        public void initialize(ServerMetadata serverMetadata) {
            ...
            // load template
            console = TemplateCompiler.compileTemplate(getClass().getClassLoader().getResourceAsStream(
                    "org.restexpress.plugin.console.html"));
            if (console == null)
        ...
        /**
         * Returns information on a single route. <code>/routes/metadata/{routeName}</code>
         * 
         * @param request
         * @param response
         * @return {@link ServerMetadata}
         * @throws NotFoundException if route can not be found
         */
