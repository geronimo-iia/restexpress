...
/**
 * HttpDateTimeFormatTest.
 * 
 * @author <a href="mailto:jguibert@intelligents-ia.com" >Jerome Guibert</a>
 * 
 */
public class HttpDateTimeFormatTest {
	...
	public void defaultFormatShouldBeRFC1123() {
		...
		assertEquals(HttpDateTimeFormat.defaultFormat(calendar.getTime()), HttpDateTimeFormat.RFC_1123.format(calendar.getTime()));
	}
	...
	public void shouldOutput_Day_dd_MMM_yyyy_HH_mm_ss_GMT() {
		calendar.set(2010, Calendar.APRIL, 7, 13, 30, 37);
		calendar.set(Calendar.MILLISECOND, 123);
		assertEquals("Wed, 07 Apr 2010 13:30:37 GMT", HttpDateTimeFormat.RFC_1123.format(calendar.getTime()));
	}

	@Test
	public void shouldParse_ZeroTime() throws ParseException {
		final Date date = HttpDateTimeFormat.parseAny("Sun, 06 Nov 1994 00:00:00 GMT");
		assertNotNull(date);
	...
	public void shouldParse_MaxTime() throws ParseException {
		final Date date = HttpDateTimeFormat.parseAny("Sun, 06 Nov 1994 23:59:59 GMT");
		assertNotNull(date);
	...
	public void shouldParse_Day_dd_MMM_yyyy_HH_mm_ss_GMT() throws ParseException {
		final Date date = HttpDateTimeFormat.parseAny("Sun, 06 Nov 1994 08:49:37 GMT");
		assertNotNull(date);
	...
	public void shouldParse_Day_dd_MMM_yy_HH_mm_ss_GMT() throws ParseException {
		final Date date = HttpDateTimeFormat.parseAny("Sunday, 06-Nov-94 08:49:37 GMT");
		assertNotNull(date);
	...
	public void shouldParse_Day_d_MMM_HH_mm_ss_yyyy() throws ParseException {
		final Date date = HttpDateTimeFormat.parseAny("Sun Nov  6 08:49:37 1994");
		assertNotNull(date);
	...
	public void shouldParse_Day_dd_MMM_HH_mm_ss_yyyy() throws ParseException {
		final Date date = HttpDateTimeFormat.parseAny("Sun Nov 16 08:49:37 1994");
		assertNotNull(date);
	...
	public void shouldParse_yyyy_MM_ddTHH_mm_ss_SSSZ() throws ParseException {
		...
		final Date date = HttpDateTimeFormat.parseAny("2010-04-07T11:52:13.123Z");
		assertNotNull(date);
	...
	public void shouldParse_yyyy_MM_dd() throws ParseException {
		final Date date = HttpDateTimeFormat.parseAny("2010-04-07");
		assertNotNull(date);
	...
	public void checkParseFormat() throws ParseException {
	  final Date date = HttpDateTimeFormat.parseAny("2010-12-17T120000Z");
	 System.err.println( HttpDateTimeFormat.ISO_8601.format(date));
