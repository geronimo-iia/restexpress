 ...
 * 
 */
public enum HttpDateTimeFormat {
    ...
    private HttpDateTimeFormat(final String format) {
        this.format = format;
    }
    ...
    public static Date parseAny(final String source) throws ParseException {
        ...
        for (final HttpDateTimeFormat formater : HttpDateTimeFormat.values()) {
            try {
    ...
    public static String defaultFormat(final Date date) {
        return HttpDateTimeFormat.RFC_1123.format(date);
    }
}
